			...
			<div style="width: 70%; height: 100%; display: inline-block;">
				<div style="display: flex; justify-content: space-between;">
					...
					<span style="text-align: right;">
						<input type="button" onclick="location='/WebDBTermProject/Page/MainPage/UserMain/UserMain.jsp'" value="처음으로" style="padding: 5px; font-size: 12px;" class="btnGroup"/>
						<input type="button" onclick="location='/WebDBTermProject/Page/InfoPage/InfoPage.jsp'" value="지원목록" style="padding: 5px; font-size: 12px;" class="btnGroup"/>
